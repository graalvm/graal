...
public final class PolyglotCompilerOptions {
    ...
    @Option(help = "Exclude a specific method from being inlined.", category = OptionCategory.INTERNAL)
    public static final OptionKey<String> ExcludeInlining = new OptionKey<>("");
